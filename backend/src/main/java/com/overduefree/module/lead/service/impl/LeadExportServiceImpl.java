...
public class LeadExportServiceImpl implements LeadExportService {
    ...
    private static final List<LeadExportField> DEFAULT_FIELDS = Arrays.asList(
        ...
        new LeadExportField("debtDescription", "债务描述", LeadListItem::getDebtDescription),
        new LeadExportField("ageRange", "年龄", LeadListItem::getAgeRange),
        new LeadExportField("jobStatus", "工作情况", LeadListItem::getJobStatus),
        new LeadExportField("creditStatus", "征信情况", LeadListItem::getCreditStatus),
        new LeadExportField("monthlyIncomeRange", "月收入", LeadListItem::getMonthlyIncomeRange),
        new LeadExportField("monthlyExpenseRange", "月开销", LeadListItem::getMonthlyExpenseRange),
